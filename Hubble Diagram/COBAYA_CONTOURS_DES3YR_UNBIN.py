...
# Import Chains for all the models DES3YR_BIN - Missing LTB & F(R)

FLCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FLCDM_DES3YR_UNBIN.1.txt', usecols=(2), comments='#')
LCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/LCDM_DES3YR_UNBIN.1.txt', usecols=(2,3), comments='#')
FwCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FwCDM_DES3YR_UNBIN.1.txt', usecols=(2,3), comments='#')
wCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/wCDM_DES3YR_UNBIN.1.txt', usecols=(2,3,4), comments='#')
Fwa_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/Fwa_DES3YR_UNBIN.1.txt', usecols=(2,3,4), comments='#')
Fwz_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/Fwz_DES3YR_UNBIN.1.txt', usecols=(2,3,4), comments='#')
IDE1_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/IDE1_DES3YR_UNBIN.1.txt', usecols=(2,3,4,5), comments='#')
IDE2_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/IDE2_DES3YR_UNBIN.1.txt', usecols=(2,3,4,5), comments='#')
IDE4_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/IDE4_DES3YR_UNBIN.1.txt', usecols=(2,3,4,5), comments='#')
FGChap_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FGChap_DES3YR_UNBIN.1.txt', usecols=(2,3), comments='#')
GChap_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/GChap_DES3YR_UNBIN.1.txt', usecols=(2,3,4), comments='#')
Chap_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/Chap_DES3YR_UNBIN.1.txt', usecols=(2,3), comments='#')
FCa_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FCa_DES3YR_UNBIN.1.txt', usecols=(2,3,4), comments='#')
...
c.add_chain(LCDM_COBAYA_CHAIN, parameters=label_LCDM, linewidth=2.0, name="LCDM", kde=1.5, color="red",num_free_params=2).configure(summary=True, shade_alpha=0.2,statistics="max")
...
ax.text(1.15,0.55,'$\Omega_m = %10.5s\pm{%10.5s}$' %(om,omp), family='serif',color='black',rotation=0,fontsize=12,ha='right') 
ax.text(1.15,0.4,'$\Omega_{\Lambda} = %10.5s\pm{%10.5s}$' %(ol,olp), family='serif',color='black',rotation=0,fontsize=12,ha='right')
...
### FwCDM PLOT
name = FwCDM.__name__
c.add_chain(FwCDM_COBAYA_CHAIN[200:], parameters=label_FwCDM, linewidth=2.0, name=name, kde=1.5, color="red",num_free_params=len(begin_FwCDM)).configure(summary=True, shade_alpha=0.2,statistics="max")
...
ax.text(0.12,-1.75,'$\Omega_m = %10.5s^{%10.5s}_{%10.5s}$' %(FwCDM_om,FwCDM_omp,FwCDM_omm), family='serif',color='black',rotation=0,fontsize=12,ha='left') 
ax.text(0.12,-1.75-0.15,'$\omega = %10.5s^{%10.5s}_{%10.5s}$' %(FwCDM_w,FwCDM_wp,FwCDM_wm), family='serif',color='black',rotation=0,fontsize=12,ha='left')
ax.set_xlabel(r'$\Omega_m$', fontsize = 18)
...
### wCDM PLOT
name = wCDM.__name__
c.add_chain(wCDM_COBAYA_CHAIN[1000:], parameters=label_wCDM, linewidth=2.0, name=name, kde=1.5, color="red",num_free_params=len(begin_wCDM)).configure(summary=True, shade_alpha=0.2,statistics="max")
...
# Unique to model
ax.text(1.1,-1.65,'$\Omega_m = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_om,wCDM_omp,wCDM_omm), family='serif',color='black',rotation=0,fontsize=12,ha='right') 
ax.text(1.1,-1.65-0.13,'$\Omega_{\Lambda} = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_ol,wCDM_olp,wCDM_olm), family='serif',color='black',rotation=0,fontsize=12,ha='right')
ax.text(1.1,-1.65-0.26,'$\omega = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_o,wCDM_op,wCDM_omi), family='serif',color='black',rotation=0,fontsize=12,ha='right')
ax.set_xlabel(r'$\Omega_m$', fontsize = 18)
ax.set_ylabel(r'$\omega$', fontsize = 18)
...
c.add_chain(FGChap_COBAYA_CHAIN[200:], parameters=[r'$A$', r'$\alpha$'], linewidth=2.0, name="FGChap", kde=1.5, color="red",num_free_params=2, num_eff_data_points=20).configure(summary=True, shade_alpha=0.2,statistics="max")
...
ax.text(0.91,-0.59,r'$A = %10.5s^{%10.5s}_{%10.5s}$' %(FGChap_A,FGChap_Ap,FGChap_Am), family='serif',color='black',rotation=0,fontsize=16,ha='right') 
ax.text(0.91,-0.59-0.3,r'$\alpha = %10.5s^{%10.5s}_{%10.5s}$' %(FGChap_a,FGChap_ap,FGChap_am), family='serif',color='black',rotation=0,fontsize=16,ha='right')
...
ax.set_ylim(-1,2)
ax.set_xticklabels(['','0.55','','0.65','','0.75','','0.85',''])
plt.minorticks_on()
ax.tick_params(which = 'both', bottom=True, top=True, left=True, right=True, direction="in")
...
### GCHAP PLOT 
c.add_chain(GChap_COBAYA_CHAIN[2000:], parameters=[r"$A$",r"$\alpha$",r"$\Omega_{K}$"], linewidth=2.0, name="GChap", kde=1.5, color="red",num_free_params=2).configure(summary=True, shade_alpha=0.2,statistics="max")
...
# The actual chain this code is about
c.add_chain(Fwz_COBAYA_CHAIN[1000:], parameters=label_Fwz, linewidth=2.0, name=name, kde=1.5, color="red",num_free_params=len(begin_Fwz)).configure(summary=True, shade_alpha=0.2,statistics="max")
...
ax.axhline(0,color = 'k', ls = ':', linewidth=1, zorder = 1)
ax.scatter(-1, 0, marker = 'x', s = 70, c='black', zorder = 3)
ax.text(-4.6,-6,'$\Omega_m = %10.5s^{%10.5s}_{%10.5s}$' %(Fwz_om,Fwz_omp,Fwz_omm), family='serif',color='black',rotation=0,fontsize=12,ha='left') 
ax.text(-4.6,-6-1.5,'$\omega_0 = %10.5s^{%10.5s}_{%10.5s}$' %(Fwz_o0,Fwz_o0p,Fwz_o0m), family='serif',color='black',rotation=0,fontsize=12,ha='left')
ax.text(-4.6,-6-3,'$\omega_{z} = %10.5s^{%10.5s}_{%10.5s}$' %(Fwz_oz,Fwz_ozp,Fwz_ozm), family='serif',color='black',rotation=0,fontsize=12,ha='left')
ax.set_xlabel(r'$\omega_0$', fontsize = 18)
ax.set_ylabel(r'$\omega_z$', fontsize = 18)
...
# The actual chain this code is about
c.add_chain(IDE1_COBAYA_CHAIN[1000:], parameters=label_IDE1, linewidth=2.0, name=name, kde=1.5, color="red",num_free_params=len(begin_IDE1)).configure(summary=True, shade_alpha=0.2,statistics="max")
...
# The actual chain this code is about
c.add_chain(IDE2_COBAYA_CHAIN[500:], parameters=label_IDE2, linewidth=2.0, name=name, kde=1.5, color="red",num_free_params=len(begin_IDE1)).configure(summary=True, shade_alpha=0.2,statistics="max")
