...
FLCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FLCDM_DES3YR_BIN.1.txt', usecols=(2), comments='#')
LCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/LCDM_DES3YR_BIN.1.txt', usecols=(2,3), comments='#')
FwCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/FwCDM_DES3YR_BIN.1.txt', usecols=(2,3), comments='#')
wCDM_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/wCDM_DES3YR_BIN.1.txt', usecols=(2,3,4), comments='#')
Fwa_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/Fwa_DES3YR_BIN.1.txt', usecols=(2,3,4), comments='#')
Fwz_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/Fwz_DES3YR_BIN.1.txt', usecols=(2,3,4), comments='#')
IDE1_COBAYA_CHAIN = np.loadtxt('/Users/RyanCamo/Desktop/Cobaya/chains/IDE1_DES3YR_BIN.1.txt', usecols=(2,3,4,5), comments='#')
...
ax.text(1.2,0.4,'$\Omega_m = %10.5s\pm{%10.5s}$' %(om,omp), family='serif',color='black',rotation=0,fontsize=12,ha='right') 
ax.text(1.2,0.25,'$\Omega_{\Lambda} = %10.5s\pm{%10.5s}$' %(ol,olp), family='serif',color='black',rotation=0,fontsize=12,ha='right')
...
# Unique to model
ax.text(1.15,-1.65,'$\Omega_m = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_om,wCDM_omp,wCDM_omm), family='serif',color='black',rotation=0,fontsize=12,ha='right') 
ax.text(1.15,-1.65-0.13,'$\Omega_{\Lambda} = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_ol,wCDM_olp,wCDM_olm), family='serif',color='black',rotation=0,fontsize=12,ha='right')
ax.text(1.15,-1.65-0.26,'$\omega = %10.5s^{%10.5s}_{%10.5s}$' %(wCDM_o,wCDM_op,wCDM_omi), family='serif',color='black',rotation=0,fontsize=12,ha='right')
ax.set_xlabel(r'$\Omega_m$', fontsize = 18)
ax.set_ylabel(r'$\omega$', fontsize = 18)
